    ...
    <footer :class="footerClass">
      <div class="w-full max-w-screen-xl m-auto">
        <div class="flex items-center justify-between space-x-2">
          ...
          <HoverButton v-if="!isMobile" tooltip="保存对话到图片" @click="handleExport">
            <p style="margin-right:10px" class="flex items-center clsss justify-center w-10 h-10 transition rounded-full hover:bg-neutral-100 dark:hover:bg-[#f0a020]">
              <span class="text-xl text-[#4f555e] dark:text-white">
          ...
          <NAutoComplete v-model:value="prompt" :options="searchOptions" :render-label="renderOption">
            <template #default="{ handleInput, handleBlur, handleFocus }">
              <NInput
                ...
                style="
                  --n-caret-color: #fcb040;
                  --n-border-hover: 1px solid #fcb040;
                  --n-border-focus: 1px solid #fcb040;
                  --n-box-shadow-focus: 0 0 0 2px rgba(255, 231, 174, 0.8);
                  --n-loading-color: rgba(255, 231, 174, 1)
                "
