...
ary[ary.length] = 40;
console.log(res, ary); *///res新增后数组的长度
...
// 基于原生JS中的DELETE，把数组当做普通的对象，
确实可以删除掉某一项内容，但是不会影响数组本身的结构特点（length长度不会跟着修改）
,真实项目中杜绝这样的删除使用
delete ary[0];
...
console.log(res); *///[10, 20, 30,'珠峰培训',40, 50, 60]
...
// a和b是相邻的两项
ary.sort((a, b) => a - b);
console.log(ary); *///ary = [9, 10, 12, 15, 22, 28];
...
//在控制台中查看数组的方法Array.prototype,可以基于MDN网站去查询方法的使用